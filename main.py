...
ГФС:88003013638 (доб.625 ДЕНИС ЕВГЕНЬЕВИЧ МИШИН)
ПОДДЕРЖКА КИТ: 88001000107(КМУТ)
ПОДДЕРЖКА ЦКИЗ: 88003019927 (КРИПТОШЛЮЗ)
ПОДДЕРЖКА : 8800-301-02-12
ПОДДЕРЖКА Т2 : 8800-300-6611 (доб.6611)""",
    }
